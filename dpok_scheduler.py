...
class DPOKDDIMScheduler(DDIMScheduler):
  ...
  def step_logprob(
    ...
    #print('step_logrpb pred_sample_direction ',pred_sample_direction)
    #print('step_logrpb pred_original_sample ',pred_original_sample)
    ...
    if eta > 0:
      ...
      #print('step_logprob line 236 prev_sample',prev_sample)
      #print('step_logprob line 236 std_dev_t',std_dev_t)
